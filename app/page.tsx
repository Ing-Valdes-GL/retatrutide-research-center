...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#14532d] overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="hidden lg:block w-[260px] h-[280px] rounded-t-full overflow-hidden flex-shrink-0"
            style={{
      ...
      {/* ── STATS BAR ── */}
      <section ref={statsRef as React.RefObject<HTMLElement>} className="py-14" style={{ background: '#f0fdf4', borderBottom: '1px solid rgba(132,204,22,0.12)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                <img src="/leaf-white.png" className="w-8 mb-6 opacity-80" alt="" />
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] -z-10 rounded-[40%_60%_70%_30%/40%_50%_60%_70%] pointer-events-none"
          ...
          >
            ...
            <div className="flex-1 w-full h-full min-h-[360px] flex items-center justify-center relative"
              ...
              <div className="absolute left-0 top-0 bottom-0 w-24 hidden md:block"
                style={{ background: 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)', clipPath: 'polygon(0 0, 0% 100%, 100% 0)' }} />
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <motion.div {...springIn(0.3)} className="flex gap-4 flex-wrap justify-center">
            <Link href="/products"
              className="group lg-btn-accent inline-flex items-center gap-3 px-10 py-4 rounded-xl font-bold uppercase text-[12px] tracking-[0.15em]">
              Shop RRC Products
