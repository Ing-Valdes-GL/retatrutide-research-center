...
import { ShoppingCart, ArrowRight, X, Smartphone, Zap, ShieldCheck, ChevronDown } from 'lucide-react'
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0A0A0B]">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-[#050505]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <Image
            ...
            alt=""
            fill
            className="hero-poster object-cover hidden"
            priority
          />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10 flex items-center justify-between">
          ...
          <div className="flex flex-col items-center text-center flex-grow px-10">
            ...
            <h1
              className="text-4xl md:text-6xl font-black text-white leading-[0.8] tracking-[-0.06em] uppercase mb-8 opacity-0"
            ...
            <p
              className="text-xl md:text-3xl text-gray-400 font-medium tracking-tight mb-12 opacity-0"
            ...
            >
              <Link
                href="/products"
                className="group relative bg-gradient-to-r from-[#0ea5e9] to-[#38bdf8] text-white px-14 py-5 rounded-xl font-black uppercase text-sm tracking-[0.2em] shadow-[0_15px_40px_rgba(14,165,233,0.3)] transition-all hover:scale-105"
              >
      ...
      {/* ── BEST SELLERS ── */}
      <section
        ref={sellersRef as React.RefObject<HTMLElement>}
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div
              className={`bg-[#1e3a8a] rounded-xl p-10 flex flex-col justify-end min-h-[450px] relative overflow-hidden group transition-all duration-700 ${sellersInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
            ...
            {products.map((product, i) => (
              <div
                key={product.id}
                className={`group border border-gray-100 rounded-xl p-6 flex flex-col hover:shadow-xl transition-all duration-700 ${sellersInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-500 leading-relaxed mb-6 max-w-lg">
                Part of <span className="text-[#0ea5e9] font-bold">Retatrutide Research Center&apos;s</span> ongoing research program into advanced GLP-1 multi-agonist compounds. This formulation is supplied in controlled batches for laboratory analysis of stability, compound behaviour, and injector system performance.
              </p>
              ...
              <Link
                href="/about"
                className="bg-[#0ea5e9] text-white px-8 py-4 rounded-lg font-black uppercase text-[10px] tracking-widest flex items-center gap-3 w-fit hover:bg-black transition-all shadow-xl shadow-sky-200"
              >
                About Store <ArrowRight size={14} />
              </Link>
            </div>
            <div className="lg:w-1/2 relative">
              {/* Molecule video replacing static image */}
              <div
                className="relative z-10 rounded-2xl overflow-hidden transition-all duration-400 hover:shadow-[0_0_40px_rgba(14,165,233,0.18)]"
        ...
        <div className="container mx-auto px-6">
          <div className="bg-[#050A30] rounded-3xl overflow-hidden flex flex-col md:flex-row items-center relative min-h-[380px]">
            <div className="flex-1 p-12 lg:p-20 z-10">
              ...
              <Link
                href="/products"
                className="inline-flex items-center gap-3 border-2 border-white/20 text-white px-8 py-3 rounded-full font-black uppercase text-[10px] tracking-widest hover:bg-white hover:text-black transition-all"
              >
            ...
            <div className="flex-1 bg-[#1e3a8a] w-full h-full min-h-[380px] flex items-center justify-center relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <h4 className="text-white text-7xl font-black opacity-40 absolute -left-20 top-1/2 -translate-y-1/2 rotate-[-90deg]">
                  RRC
                </h4>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            >
              <Link
                href="/products"
                className="group relative inline-flex items-center justify-center px-10 py-4 border border-white/60 rounded-lg overflow-hidden text-white font-bold uppercase text-[12px] tracking-[0.15em] transition-all duration-300 ease-out"
              >
